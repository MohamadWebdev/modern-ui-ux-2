  ...
  return (
    <section className="w-full z-[10] flex text-white justify-between flex-wrap max-md:flex-col max-md:items-center max-md:mt-10">
      <div className="flex max-sm:flex-col">
        <Image width={1000} height={1000} className="w-[205.16px] mr-5 h-[277.16]" src="/img/Group1.png" alt="" />
        <Image width={1000} height={1000} className="w-[205.16px] h-[277.16] mt-25" src="/img/Group2.png" alt="" />
      </div>
